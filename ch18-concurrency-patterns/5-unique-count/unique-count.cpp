...
void count_unique(std::vector<int> data, std::size_t &result)
{
  std::sort(data.begin(), data.end());
  result = std::unique(data.begin(), data.end()) - data.begin();
}

void count_unique_even(std::vector<int> data, std::size_t &result)
{
